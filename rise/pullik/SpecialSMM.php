...
define("DB_USERNAME", "rixbuilder"); // Mysql baza nomi
define("DB_PASSWORD", "rixbuilder"); // Mysql baza paroli
define("DB_NAME", "rixbuilder"); // Mysql baza nomi
...
if($rek == "Yoqilgan"){
	$reklama = "Ushbu bot @RixBuilderBot yordamida ochildi!";
}
	if($cid == $admin){
	bot('SendMessage',[
	'chat_id'=>$admin,
...
<i>Agar limitlarni sotib olsangiz, limit uchun olinadigan mablag' @RixBuilderBot dagi hisobingizdan yechiladi!</i>",
	'parse_mode'=>'html',
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
if($data == "api_hash"){
	...
	bot('SendMessage',[
	'chat_id'=>$cid2,
'text'=>"<b>@RixBuilderBot dan olingan HASH kalitni kiriting:</b>",
	'parse_mode'=>'html',
	'reply_markup'=>$boshqarish,
	]);
